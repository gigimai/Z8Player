...
{
    UIImage *progressImage = [[UIImage imageWithColor:progressColor cornerRadius:0.f]
                              imageWithMinimumSize:CGSizeMake(10, 10)];
    UIImage *trackImage = [[UIImage imageWithColor:trackColor cornerRadius:0.f]
                           imageWithMinimumSize:CGSizeMake(10, 10)];
    
    [self setMinimumTrackImage:progressImage forState:UIControlStateNormal];
    [self setMaximumTrackImage:trackImage forState:UIControlStateNormal];
    
    UIImage *normalSliderImage = [UIImage circularImageWithColor:normalThumbColor size:CGSizeMake(20, 20)];
